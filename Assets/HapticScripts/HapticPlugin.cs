...
public class HapticPlugin : MonoBehaviour  {
	...
	public string configName = "Default PHANToM";  //!< Filename of the Haptic Device Configuration. (Typically "Default Device")
	...
	private void updateManipulator()
	{
		...
		springVelOut[0] = springVel.x/2;
		springVelOut[1] = springVel.y/2;
		springVelOut[2] = springVel.z/2;
