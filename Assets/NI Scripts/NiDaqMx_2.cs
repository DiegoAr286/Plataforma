...
namespace Janelia_2
{
    public static class NiDaqMx_2
    {
        ...
        public static bool CreateDigitalOutput(DigitalOutputParams p, int line)
        {
            ...
            byte[] physicalChannels = MakeCString("Dev1/port0/line" + line);
            byte[] namesToAssignToChannels = MakeCString("");
